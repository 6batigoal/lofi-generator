...
CHECKPOINT_PATH = "models/lm_final_small_10.pt"
#CHECKPOINT_PATH = "models/lm_final_medium_3.pt"

print("Loading MusicGen model...")
model = MusicGen.get_pretrained("small", device=DEVICE)
#model = MusicGen.get_pretrained("medium", device=DEVICE)
model.lm.load_state_dict(torch.load(CHECKPOINT_PATH, map_location=DEVICE))
